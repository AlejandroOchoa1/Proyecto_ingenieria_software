<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmUsuarios.aspx.cs" Inherits="Proyecto_ingenieria_software.frmUsuarios" %>
                ...
                <div class="col-sm-4">
                    <div class="row">
                        <div class="col-sm-12" style="text-align:center;">
                            <h1><b><asp:Label runat="server" ID="lblTitulo" Text="Usuarios"></asp:Label></b></h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
